...
-- =========================================================
-- Si elle existe déjà, tu peux sauter cette partie
CREATE TYPE IF NOT EXISTS user_role AS ENUM ('client', 'pro', 'admin');
...
-- =========================================================
-- 3) Index partiels uniques pour éviter les doubles réservations
-- =========================================================

-- Sur reservations
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS idx_reservations_unique_active 
ON reservations (event_id, floor_element_id) 
WHERE statut = 'active';

-- Sur client_reservations
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS idx_client_reservations_unique_active 
...
-- =========================================================
-- 5) (Optionnel) Clés étrangères pour jointures PostgREST
-- =========================================================
-- Permettra aux selects imbriqués de fonctionner côté PRO
